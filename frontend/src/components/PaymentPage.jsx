                  ...
                  <div className="px-6">
                    <div className="flex justify-between text-lg">
                      ...
                      <div className="text-right">
                        <p>₹{course.baseAmount || Math.round(course.price * 0.8)}</p>
                        <p className="mt-8">₹{course.platformFees || Math.round(course.price * 0.05)}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between mt-6">
                      ...
                      <p className="text-lg">₹{course.gst || Math.round(course.price * 0.18)}</p>
                    </div>
                  </div>
